package com.abed.magentaX.extrenalLib
...
@RequiresApi(19)
@PublishedApi
internal fun Animator.doOnPause(action: (animator: Animator) -> Unit) = addPauseListener(onPause = action)

/**
 * Add a listener to this Animator using the provided actions.
 */
@PublishedApi
internal fun Animator.addListener(
...
@RequiresApi(19)
@PublishedApi
internal fun Animator.addPauseListener(
